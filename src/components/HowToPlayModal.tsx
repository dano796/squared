        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={row}>
              ...
              />
              <span style={rowText}>
                <b style={{ color: "#c8c6e0" }}>Standing</b> — can fall into the
                hole
              </span>
            </div>
            <div style={row}>
              ...
              />
              <span style={rowText}>
                <b style={{ color: "#c8c6e0" }}>Lying flat</b> — must roll
                upright first
              </span>
            </div>
          </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={row}>
              ...
              <span style={{ ...rowText, color: "#a08ef8" }}>
                Goal — land upright to win
              </span>
            </div>
            <div style={row}>
              {swatch({ background: "#3a2000", border: "1px solid #c9963a" })}
              <span style={{ ...rowText, color: "#c9963a" }}>
                Fragile — breaks if you stand upright
              </span>
            </div>
            <div style={row}>
              {swatch({ background: "#052b12", border: "1px solid #5aaf7a" })}
              <span style={{ ...rowText, color: "#5aaf7a" }}>
                Soft switch — any touch activates
              </span>
            </div>
            <div style={row}>
              {swatch({ background: "#3e0a0a", border: "1px solid #d85a5a" })}
              <span style={{ ...rowText, color: "#d85a5a" }}>
                Hard switch — must stand upright
              </span>
            </div>
          </div>
        </div>
