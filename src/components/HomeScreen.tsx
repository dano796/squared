...
const btn = {
  primary: {
    ...
    width: "100%",
    boxShadow:
      "0 4px 20px rgba(107,124,248,0.35), 0 1px 0 rgba(255,255,255,0.1) inset",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 55% 35% at 50% 30%, rgba(107,124,248,0.08) 0%, transparent 70%)",
        }}
      />
          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  "inset 0 2px 0 rgba(255,255,255,0.18), 3px 3px 0 #1a2890, 5px 5px 0 #111f70",
              }}
            />
          </div>
        </div>
